...
\restrict POrhvuikpfyOgh4T5bkA0erl29JJv9DQRuSCcy6pPrgeah2BKTkq5dXLiXhuVy0
...
--
-- Name: allocate_resource(integer, public.resource_type, character varying, character varying, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION allocate_resource(p_project_id integer, p_type public.resource_type, p_name character varying, p_value character varying, p_description text); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: get_next_available_port(integer, integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_next_available_port(start_port integer, end_port integer); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: get_object_hierarchy(uuid); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: is_resource_available(public.resource_type, character varying); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_resource_available(p_type public.resource_type, p_value character varying); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: log_entity_change(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: release_resource(integer); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION release_resource(p_resource_id integer); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: search_documents(text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_resources_timestamp(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_sync_status_on_doc_change(); Type: FUNCTION; Schema: public; Owner: -
--
...
COMMENT ON TABLE public.audit_log IS 'Security audit log for all user actions';
...
--
-- Name: port_ranges; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE port_ranges; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: port_ranges_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: port_ranges_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: TABLE resource_dependencies; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE resource_history; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: TABLE resource_projects; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: resource_projects_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: resource_projects_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.users (
    ...
    oauth2_provider character varying(50),
    oauth2_id character varying(255),
...
COMMENT ON TABLE public.users IS 'User accounts with authentication and authorization';
...
--
-- Name: v_active_databases; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: v_active_directories; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: v_active_ports; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: v_available_ports; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: v_documents_search; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: v_objects_full; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: v_project_resources; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: port_ranges id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: resource_projects id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: documents documents_object_id_folder_filename_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: object_tags object_tags_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: objects objects_uuid_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: port_ranges port_ranges_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: resource_projects resource_projects_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: resource_projects resource_projects_slug_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sync_status sync_status_entity_type_entity_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: resource_dependencies unique_dependency; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: resources unique_resource_value; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_documents_content_fts; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_documents_filename_fts; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_documents_object; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_objects_category; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_objects_subcategory; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_objects_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_objects_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_resource_history_resource; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_resource_projects_kms; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_resources_project; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_resources_value; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_sync_status_entity; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_users_oauth2; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_users_oauth2 ON public.users USING btree (oauth2_provider, oauth2_id);
...
--
-- Name: categories log_categories_changes; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: documents log_documents_changes; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: objects log_objects_changes; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: subcategories log_subcategories_changes; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: documents notify_documents_change; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: objects notify_objects_change; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: resource_projects trigger_projects_timestamp; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: resources trigger_resources_timestamp; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: documents update_sync_status_documents; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: sync_status update_sync_status_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: documents documents_object_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: object_tags object_tags_object_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: object_tags object_tags_tag_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: objects objects_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: objects objects_subcategory_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: resource_dependencies resource_dependencies_depends_on_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: resource_dependencies resource_dependencies_resource_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: resource_projects resource_projects_kms_object_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: resources resources_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict POrhvuikpfyOgh4T5bkA0erl29JJv9DQRuSCcy6pPrgeah2BKTkq5dXLiXhuVy0
